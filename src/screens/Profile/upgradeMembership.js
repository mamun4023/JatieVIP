    ...
    return(
        <View style = {styles.container}>
            ...
            <View style = {styles.headerTxtContainer}>
                ...
                <Text style = {[TextStyles.header, {color : 'black'}]} > {strings.profile.vipMemberShip} </Text>
            </View>

            <View style = {styles.card}>
                <Text style = {[TextStyles.header, {fontSize : 15, color : 'black'}]}> {strings.profile.benefits} </Text>
