...
import { StyleSheet, View , Text, Image, Linking, ScrollView } from "react-native";
    ...
    return(
        <View style = {styles.contianer}>
            ...
            <View style = {styles.postContainer}>
                ...
                <View style = {styles.jatieBrand}>
                    {infoBox(Info.jatieBrand)}
                </View>
...
const Data = {
      id : 1,
      thumbnail : 'https://www.dharmann.com/wp-content/uploads/2022/06/YT-Thumbnail-566-Husband-Pranks-Wife-Goes-Too-Far-Option-1E.jpg',
      video : [
        {
            vID : 1,
            videoLink : 'https://www.dharmann.com/wp-content/uploads/2022/06/YT-Thumbnail-566-Husband-Pranks-Wife-Goes-Too-Far-Option-1E.jpg',
        },
        {
            vID : 2,
            videoLink : 'https://www.dharmann.com/wp-content/uploads/2022/06/YT-Thumbnail-566-Husband-Pranks-Wife-Goes-Too-Far-Option-1E.jpg',
      ...
      photo : [
            {
                pID : 1,
                photoLink : 'https://media.istockphoto.com/id/1309328823/photo/headshot-portrait-of-smiling-male-employee-in-office.jpg?b=1&s=170667a&w=0&k=20&c=MRMqc79PuLmQfxJ99fTfGqHL07EDHqHLWg0Tb4rPXQc=',
            },
            {
                pID : 2,
                photoLink : 'https://media.istockphoto.com/id/1309328823/photo/headshot-portrait-of-smiling-male-employee-in-office.jpg?b=1&s=170667a&w=0&k=20&c=MRMqc79PuLmQfxJ99fTfGqHL07EDHqHLWg0Tb4rPXQc=',
      ...
      description : 'Nothing like starting an argument with your wife for fun lol.. Hope you guys enjoyed this video and get ready for vlogmas starting tomorrow!!'
}
