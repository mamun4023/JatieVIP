...
import { faBellSlash, faBoxArchive, faChevronDown, faFlag, faMessage, faSearch, faTrash, faUserPlus, faXmark } from '@fortawesome/free-solid-svg-icons';
import { ms, vs } from 'react-native-size-matters';
import { AppSwitch, Button, HorizontalLine, Icon, ModalDown, ModalList, VerticalLine } from '@/components';
          ...
          <View>
              ...
              <View style = {styles.filterContainer}> 
                ...
                <View style = {styles.filter}> 
                  <Text style = {styles.filterTxt}> {strings.message.unreadOnly} </Text>
                  <AppSwitch 
                ...
                <VerticalLine />
                <View style = {styles.filter}> 
                  <Text style = {styles.filterTxt}> {strings.message.archive} </Text>
                  <AppSwitch 
                    value = {archiveSwitch}
                    onChange = {setArchiveSwitch}
                  />
                </View>
              </View>
          </View>
                ...
                style = {styles.messageCard} >
                  <View style = {styles.messageHeader}>
                      ...
                      <View style = {styles.messageCardRight} >
                        <Text style = {styles.minTxt}> 32 mins </Text>
...
const Data = [
  ...
  },
  {
    ...
    name : "Key Totleben",
    userName : '@key',
    profilePic : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwWJhYf8YJC8vIGrRT1USlzp5uGnOGJzxFVQ&usqp=CAU',
    textMessage : 'We hope you love the product making...',
    time : 10,
    online : true,
  },
