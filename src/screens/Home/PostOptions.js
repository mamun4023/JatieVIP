import { AppDatePicker, AppSwitch, Button, Icon, TextField, TopBackButton } from "@/components";
                ...
                <View style = {styles.optionContainer}>
                    ...
                    {ad && 
                        <View>             
                            <View style = {styles.list}>
                                <View style = {styles.left}>
                                    <Text style = {styles.publishingTxt}>{strings.home.publishingDate} </Text>         
                                </View>
                                <View style = {styles.right}>
                                {/* Date picker  */}
                                    <View>
                            ...
                            <View style = {styles.list}>
                                <View style = {styles.left}>
                                    <Text style = {styles.publishingTxt}>{strings.home.ExpirationDate}</Text>                                            
                                </View>
                                <View style = {styles.right}>
                                {/* Date picker  */}
                                    <View >
